...
class CreatePremierServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('premier_services', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('model_name')->default('Premier Service');
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::dropIfExists('premier_services');
    }
}
