...
class CreateLegalComplainServicesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('legal_complaints_services', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('model_name')->default('Legal Complaints Service');
            $table->timestamps();
            $table->softDeletes();
        });
    }
    ...
    {
        Schema::dropIfExists('legal_complain_services');
    }
}
