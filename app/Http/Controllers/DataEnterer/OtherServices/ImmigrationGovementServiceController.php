...
class ImmigrationGovementServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenImmigrationService = ImmigrationGovementService::where('creator_id', Auth::user()->id)->orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('DataEnterer.otherServices.immigrationGovementService.create', compact('immigrationGovementServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataEnterer.immigrationGovementService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('DataEnterer.otherServices.immigrationGovementService.view', compact('immigrationGovementService', 'onload', 'print'));
    }
