...
class OtherServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $otherServices = Other::where('creator_id', Auth::user()->id)->orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('DataEnterer.otherServices.otherService.create', compact('branchs', 'professions'));
    }
    ...
    public function printReceipt($id)
    {
        ...
        return view('DataEnterer.otherServices.otherService.printRecipt', compact('serviceData', 'onload'));
    }
    ...
    public function printSticker($id)
    {
        ...
        return view('DataEnterer.otherServices.otherService.printSticker', compact('serviceData', 'onload'));
    }
    ...
    public function show($id)
    {
        ...
        $print = true;
        $bold = true;
        return view('DataEnterer.otherServices.otherService.view', compact('serviceData', 'onload', 'print', 'bold'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('DataEnterer.otherServices.otherService.edit', compact('branchs', 'otherService', 'professions'));
    }
