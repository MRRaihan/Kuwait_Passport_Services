...
class ExpressServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenExpressService = ExpressService::where('creator_id', Auth::user()->id)->orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('DataEnterer.otherServices.expressService.create', compact('expressServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataEnterer.expressService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('DataEnterer.otherServices.expressService.view', compact('expressService', 'onload', 'print'));
    }
