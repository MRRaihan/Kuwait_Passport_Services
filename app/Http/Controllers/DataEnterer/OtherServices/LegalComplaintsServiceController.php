...
class LegalComplaintsServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenLegalComplaintsServices = LegalComplaintsService::where('creator_id', Auth::user()->id)->orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('DataEnterer.otherServices.LegalComplainService.create', compact('legalComplaintsServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataEnterer.legalComplaintsService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('DataEnterer.otherServices.LegalComplainService.view', compact('legalComplaintsService', 'onload', 'print'));
    }
