...
class PremierServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenPremierServices = PremierService::where('creator_id', Auth::user()->id)->orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('DataEnterer.otherServices.PremierService.create', compact('premierServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dataEnterer.PremierService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('DataEnterer.otherServices.PremierService.view', compact('premierService', 'onload', 'print'));
    }
