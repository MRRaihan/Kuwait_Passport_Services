...
class OtherServicesReportController extends Controller
{
    public function getReport($data)
    {
        ...
        if ($option == -1) {
            ...
            if (isset($excel_export) && $excel_export == true) {
                return downloadExcel('Admin.report.otherServices.report_excel', $data, 'all_services', 'xlsx');
            }
            return view('Admin.report.otherServices.report', $data);
        }
        ...
        if ($option == 0) {
            ...
            if (isset($excel_export) && $excel_export == true) {
                return downloadExcel('Admin.report.otherServices.report_excel', $data, 'premier', 'xlsx');
            }
            return view('Admin.report.otherServices.report', $data);
        }
        ...
        if ($option == 1) {
            ...
            if (isset($excel_export) && $excel_export == true) {
                return downloadExcel('Admin.report.otherServices.report_excel', $data, 'express', 'xlsx');
            }
            return view('Admin.report.otherServices.report', $data);
        }
        ...
        if ($option == 2) {
            ...
            if (isset($excel_export) && $excel_export == true) {
                return downloadExcel('Admin.report.otherServices.report_excel', $data, 'legal', 'xlsx');
            }
            return view('Admin.report.otherServices.report', $data);
        }
        ...
        if ($option == 3) {
            ...
            if (isset($excel_export) && $excel_export == true) {
                return downloadExcel('Admin.report.otherServices.report_excel', $data, 'immigration', 'xlsx');
            }
            return view('Admin.report.otherServices.report', $data);
        }
        ...
        if ($option == 4) {
            ...
            if (isset($excel_export) && $excel_export == true) {
                return downloadExcel('Admin.report.otherServices.report_excel', $data, 'other', 'xlsx');
            }
            return view('Admin.report.otherServices.report', $data);
        }
    }
    ...
    public function excelExport($data)
    {
        ...
        if ($option == 3) {
            ...
            return downloadExcel('Admin.report.all_report_excel', $data, 'other_passport', 'xlsx');
        }
    ...
    public function getReceiveReport($data)
    {
        ...
        if ($option == 3) {
            ...
            if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('Admin.report.all_report_excel', $data, 'recieve_other_passport', 'xlsx');
            } else {
                return view('Admin.report.search_report', $data);
            }
        }
    ...
    public function getDeliveryToBranchReport($data)
    {
        ...
        if ($option == 3) {
            ...
            if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('Admin.report.all_report_excel', $data, 'delivery_branch_other_passport', 'xlsx');
            } else {
                return view('Admin.report.search_report', $data);
            }
        }
    ...
    public function getDeliveryReport($data)
    {
        ...
        if ($option == 3) {
            ...
            if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('Admin.report.all_report_excel', $data, 'delivery_user_other_passport', 'xlsx');
            } else {
                return view('Admin.report.search_report', $data);
            }
        }
