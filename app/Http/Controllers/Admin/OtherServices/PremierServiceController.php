...
class PremierServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenPremierServices = PremierService::orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('Admin.otherServices.PremierService.create', compact('premierServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.PremierService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('Admin.otherServices.PremierService.view', compact('premierService', 'onload', 'print'));
    }
