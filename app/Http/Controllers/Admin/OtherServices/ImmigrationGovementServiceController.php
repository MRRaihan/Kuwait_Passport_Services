...
class ImmigrationGovementServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenImmigrationService = ImmigrationGovementService::orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('Admin.otherServices.immigrationGovementService.create', compact('immigrationGovementServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.immigrationGovementService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('Admin.otherServices.immigrationGovementService.view', compact('immigrationGovementService', 'onload', 'print'));
    }
