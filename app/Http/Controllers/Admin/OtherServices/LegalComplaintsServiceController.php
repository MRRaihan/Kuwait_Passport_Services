...
class LegalComplaintsServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenLegalComplaintsServices = LegalComplaintsService::orderBy('created_at', 'DESC')->get();
    ...
    public function create()
    {
        ...
        return view('Admin.otherServices.LegalComplainService.create', compact('legalComplaintsServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.legalComplaintsService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('Admin.otherServices.LegalComplainService.view', compact('legalComplaintsService', 'onload', 'print'));
    }
