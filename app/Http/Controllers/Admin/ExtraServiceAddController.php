...
class ExtraServiceAddController extends Controller
{
    ...
    public function addOnService($id, $type)
    {
        ...
        return view('Admin.service_addon.index', compact('premierServices', 'expressServices', 'legalComplaintsServices', 'immigrationGovementServices', 'professions', 'passportData', 'type', 'totalTakenServices'));
    }
}
