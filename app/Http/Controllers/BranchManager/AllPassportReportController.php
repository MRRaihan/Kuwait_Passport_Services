...
class AllPassportReportController extends Controller
{
    ...
    public function show($option){
        ...
        return view('BranchManager.report.allPassport.index',$data);
    }
    ...
    public function getReport($data){
        ...
        if (isset(explode('&', $data)[3] )) {
             $all_passport_report = explode('&', $data)[3] ? explode('&', $data)[3] : false;
        }
