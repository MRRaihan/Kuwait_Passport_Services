...
class ExtraServiceAddController extends Controller
{
    ...
    public function addOnService($id, $type)
    {
        ...
        return view('BranchManager.service_addon.index', compact('premierServices', 'expressServices', 'legalComplaintsServices', 'immigrationGovementServices', 'professions', 'passportData', 'type', 'totalTakenServices'));
    }
}
