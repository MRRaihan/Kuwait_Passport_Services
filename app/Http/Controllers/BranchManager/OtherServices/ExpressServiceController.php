...
class ExpressServiceController extends Controller
{
    ...
    {
        $flag = 1;
        $takenExpressService = ExpressService::where('branch_id', Auth::user()->branch_id)->orderBy('created_at', 'DESC')->get();
        return view('BranchManager.otherServices.expressService.index', compact('takenExpressService', 'flag'));
    }
    ...
    public function create()
    {
        ...
        return view('BranchManager.otherServices.expressService.create', compact('expressServices', 'professions'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('branchManager.expressService.index')->with('success', 'Services Added successfull');
    }
    ...
    public function show($id)
    {
        ...
        $onload = false;
        $print = true;
        return view('BranchManager.otherServices.expressService.view', compact('expressService', 'onload', 'print'));
    }
