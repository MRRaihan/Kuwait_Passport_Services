...
class OtherServicesReportController extends Controller
{
    ...
    public function excelExport($data)
    {
        ...
        if ($option == 3) {
            ...
            return downloadExcel('BranchManager.report.all_report_excel', $data, 'other_passport', 'xlsx');
        }
        ...
        if ($option == 4) {
            ...
            return downloadExcel('BranchManager.report.all_report_excel', $data, 'new_born_baby_passport', 'xlsx');
        }
    }
    ...
    public function shiftReport()
    {
        ...
        return view('BranchManager.report.shift_to_embassy', $data);
    }
    ...
    public function receiveReport()
    {
        ...
        return view('BranchManager.report.receive_from_embassy', $data);
    }
    ...
    public function getReceiveReport($data)
    {
        ...
        if ($option == -1) {
            ...
            if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'all_recieve_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 3) {
            ...
            if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'recieve_other_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 4) {
            ...
            if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'recieve_new_born_baby_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
    ...
    public function deliveryToBranchReport()
    {
        ...
        return view('BranchManager.report.delivery_to_branch', $data);
    }
    ...
    public function getDeliveryToBranchReport($data)
    {
        ...
        if ($option == -1) {
            ...
            if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_branch_all_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 0) {
            ...
            if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_branch_renew_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 1) {
            ...
            if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_branch_manual_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 2) {
            ...
            if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_branch_lost_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 3) {
            ...
            if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_branch_other_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 4) {
            ...
            if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_branch_new_born_baby_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
    ...
    public function getDeliveryReport($data)
    {
        ...
        if ($option == -1) {
            ...
            if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_user_all_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 0) {
            ...
            if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_user_renew_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 1) {
            ...
            if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_user_manual_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 2) {
            ...
            if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_user_lost_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 3) {
            ...
            if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_user_other_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
        ...
        if ($option == 4) {
            ...
            if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('BranchManager.report.all_report_excel', $data, 'delivery_user_new_born_baby_passport', 'xlsx');
            } else {
                return view('BranchManager.report.search_report', $data);
            }
        }
