...
class ReportController extends Controller
{
    ...
    public function show($option){
       ...
       return view('AccountManager.report.index',$data);
   }
    ...
    public function getReport($data){
       ...
       // Here Option Means Passport Type , $option == -1 means All Type of Passport $option == 0 means Lost Passport, 1 means Manual, 2 Renew, 3 Other.
        ...
        if ($option == -1) {
           ...
           return view('AccountManager.report.search_report',$data);
        }
  ...
  if ($option == 2) {
    ...
    public function shiftReport()
    {
        ...
        return view('AccountManager.report.shift_to_embassy',$data);
    ...
    public function receiveReport()
    {
        ...
        return view('AccountManager.report.receive_from_embassy',$data);
    ...
    public function getReceiveReport($data)
    {
        ...
        $new_born_baby = NewBornBabyPassport::when($branch_id > 0,function($query) use($branch_id){
            ...
            if ($option == -1) {
                ...
                if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                    return downloadExcel('AccountManager.report.all_report_excel',$data,'all_recieve_passport','xlsx');
                }else{
                    return view('AccountManager.report.search_report',$data);
                }
            }
            ...
            if ($option == 0) {
                ...
                if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'recieve_renew_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
            }
            ...
            if ($option == 1) {
                ...
                if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'recieve_manual_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
            }
        ...
        if ($option == 2) {
            ...
            if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'recieve_lost_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
        }
        ...
        if ($option == 3) {
            ...
            if (isset($receive_from_embassy) && $receive_from_embassy == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'recieve_new_born_baby_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
        }
    ...
    public function deliveryToBranchReport()
    {
        ...
        return view('AccountManager.report.delivery_to_branch',$data);
       ...
       $new_born_baby = NewBornBabyPassport::when($branch_id > 0,function($query) use($branch_id){
        ...
        // Here Option == -1 means all passport , option = 0 means renew Passport 1 means manual 2 means lost 3 menas other and 4 menas new born baby
            ...
            if ($option == -1) {
                $data = [
                 ...
                 if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                        return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_branch_all_passport','xlsx');
                    }else{
                    return view('AccountManager.report.search_report',$data);
                }
            }
            ...
            if ($option == 0) {
                ...
                'delivery_to_branch' => true,
                 ...
                 if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                     return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_branch_renew_passport','xlsx');
                }else{
                    return view('AccountManager.report.search_report',$data);
                }
            }
            ...
            if ($option == 1) {
                $data = [
                 ...
                 if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                     return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_branch_manual_passport','xlsx');
                }else{
                    return view('AccountManager.report.search_report',$data);
                }
            }
        ...
        if ($option == 2) {
            $data = [
             ...
             if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_branch_lost_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
        }
        ...
        if ($option == 3) {
            $data = [
             ...
             if (isset($delivery_to_branch) && $delivery_to_branch == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_branch_new_born_baby_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
        }
    ...
    public function deliveryView($option){
        ...
        return view('AccountManager.report.delivery', $data);
    }
    ...
    public function getDeliveryReport($data)
    {
       ...
       $new_born_baby = NewBornBabyPassport::when($branch_id > 0,function($query) use($branch_id){
        ...
        // Here Option == -1 means all passport , option = 0 means renew Passport 1 means manual 2 means lost 3 menas other and 4 menas new born baby
            ...
            if ($option == -1) {
                ...
                if (isset($delivery_to_user) && $delivery_to_user == true) {
                    return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_user_all_passport','xlsx');
                }else{
                    return view('AccountManager.report.search_report',$data);
                }
            }
            ...
            if ($option == 0) {
               ...
               if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_user_renew_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
            }
            ...
            if ($option == 1) {
               ...
               if (isset($delivery_to_user) && $delivery_to_user == true) {
                 return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_user_manual_passport','xlsx');
                }else{
                    return view('AccountManager.report.search_report',$data);
                }
            }
        ...
        if ($option == 2) {
           ...
           if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_user_lost_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
        }
        ...
        if ($option == 3) {
           ...
           if (isset($delivery_to_user) && $delivery_to_user == true) {
                return downloadExcel('AccountManager.report.all_report_excel',$data,'delivery_user_new_born_baby_passport','xlsx');
            }else{
                return view('AccountManager.report.search_report',$data);
            }
        }
