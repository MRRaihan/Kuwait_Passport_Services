    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Lost Passports</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-body row">
                            ...
                            <div class="col-md-4">
                                <form class="form-group" method="POST" action="{{ route('dataEnterer.lostPassport.search_by_profession_id') }}">
                                    @csrf
                                    <div class="col-sm-9">
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    @if ($flag != 0)
                        <a class="btn btn-success btn-sm" href="{{ route('dataEnterer.lostPassport.createSecond') }}"
                                    ...
                                    @foreach ($lostPassports as $lostPassport)
                                        <tr>
                                            ...
                                            <td style="width: 150px">
                                                <a href="{{ route('dataEnterer.lostPassport.receipt', $lostPassport->id) }}"
                                                    target="_blank" class="btn btn-success"><i
                                                        class="fa fa-print"></i>Receipt</a>
                                                <a href="{{ route('dataEnterer.lostPassport.sticker', $lostPassport->id) }}"
                                                    target="_blank" class="btn btn-warning"><i
                                                        class="fa fa-print"></i>Sticker</a>
                                                <a href="{{ route('dataEnterer.lostPassport.show', $lostPassport->id) }}"
                                                    target="_blank" class="btn btn-primary"><i
                                                        class="fa fa-eye"></i>
                                                </a>

                                                <button class="btn btn-success" @if ($lostPassport->is_shifted_to_branch_manager != null) disabled @endif  onclick="shiftToBranchManagerNow(this)" value="{{ route('dataEnterer.lostPassport.shiftToBranchManagerNow', $lostPassport->id) }}">Shift to Branch Manager
                                                    <i class="fa fa-external-link"></i>
                                                </button>

                                                <a href="{{ route('dataEnterer.lostPassport.agreement', $lostPassport->id) }}"
                                                    target="_blank" class="btn btn-primary"><i
                                                        class="fa fa-eye">Agreement</i></a>

                                                <a href="{{ route('dataEnterer.lostPassport.edit', $lostPassport) }}"
                                                    class="btn btn-info"><i class="fa fa-edit"></i></a>

                                                    <a href="{{ route('dataEnterer.serviceAddOn',[$lostPassport->id,"lost-passport"]) }}"
