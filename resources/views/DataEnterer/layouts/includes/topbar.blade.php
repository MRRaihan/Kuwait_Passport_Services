<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('dataEnterer.dashboard') }}" class="logo"><img src="{{ asset('assets/data-enterer/images/data_entire.png') }}" style="width: 90%; height: 90%; padding-left:30px"></a>
            <a href="{{ route('dataEnterer.dashboard') }}" class="logo-sm"><img src="{{ asset('assets/data-enterer/images/logo_sm.png') }}" height="36"></a>
        </div>
    </div>
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-footer">
                                <div class="left">
                                    <a href="{{ route('dataEnterer.profile') }}">
