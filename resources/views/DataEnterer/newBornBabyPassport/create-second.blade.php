            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">New Born Baby Passport Create</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #46bdc6 !important;">
                            <span class="panel-title">New Born Baby Passport Create
                                <!-- Button trigger modal for adding new Category -->
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm" href="{{ route('dataEnterer.newBornBabyPassport.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <form action="{{ route('dataEnterer.newBornBabyPassport.storeSecond') }}" method="post" id="basic-form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="dob_id" value='{{ old('dob_id') }}' class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="kuwait_phone" value='{{ old('kuwait_phone') }}' type="text"
