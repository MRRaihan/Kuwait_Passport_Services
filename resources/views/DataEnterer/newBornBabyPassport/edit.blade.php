                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="box-body">
                                <form action="{{ route('dataEnterer.newBornBabyPassport.update', $newBornBabyPassport) }}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="emirates_id" value='{{ $newBornBabyPassport->emirates_id }}' class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="uae_phone" value='{{ $newBornBabyPassport->uae_phone }}' type="text"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="govt_passport_id" value='{{ $newBornBabyPassport->govt_passport_id }}'
