            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading" style="background-color: #46bdc6 !important;">
                        ...
                        <div class="col-sm-12">
                            <a class="btn btn-warning btn-sm" href="{{ route('dataEnterer.otherService.index') }}" style="float: right; margin-bottom: 10px; margin-top:-26px;" ><i class="ion-chevron-left"></i>&nbsp; Back</a>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        <form action="{{ route('dataEnterer.otherService.update',$otherService) }}" method="post" id="basic-form" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                <!-----fast col start------>
