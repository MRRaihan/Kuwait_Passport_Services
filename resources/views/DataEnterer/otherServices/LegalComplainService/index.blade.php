    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    @if ($flag != 0)
                    <a class="btn btn-success btn-sm" href="{{ route('dataEnterer.legalComplaintsService.create') }}"
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        <a href="{{ route('dataEnterer.legalComplaintsService.show',$legalService->id) }}"
                                        ...
                                        <button class="btn btn-danger" onclick="delete_function(this)" value="{{ route('dataEnterer.legalComplaintsService.destroy',$legalService) }}"><i class="fa fa-trash"></i> </button>
                                    </td>
                                </tr>
                                @endforeach
