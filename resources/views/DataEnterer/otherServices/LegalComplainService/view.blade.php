...
@section('print')
    ...
    <h2> {{ env('APP_NAME') }} </h2>
        ...
        @if (!empty($legalComplaintsService->gd_report_kuwait))
            GD Report Kuwait : <a style="color:red;font-weight:bold" href="{{ asset($legalComplaintsService->gd_report_kuwait) }}" target="_blank"> View </a> <div class="padding"></div>
        @endif
