            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Premium Service Create</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                            ...
                            <span class="panel-title">Premier Service Create
                                ...
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm"
                                        href="{{ route('dataEnterer.PremierService.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <div class="row">
                                    <form action="{{ route('dataEnterer.PremierService.store') }}" method="post" id="basic-form"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input value='' class="form-control datepicker"
                                                        name="bd_phone" type="text" placeholder="bd Phone" id="bd_phone"
                                                        value="{{ old('bd_phone') }}" autocomplete="off">
                                                    @error('bd_phone')
                                                        <p class="text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
