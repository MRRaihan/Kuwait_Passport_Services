    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Premium Service</h4>
                        <ol class="breadcrumb pull-right">
                            <li><a href="{{ route('dataEnterer.dashboard') }}">Data Enterer</a></li>
                            <li class="active">Premium Service</li>
                        </ol>
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    @if ($flag)
                    <a class="btn btn-success btn-sm" href="{{ route('dataEnterer.PremierService.create') }}"
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #46bdc6 !important;">
                            <span class="panel-title">Premium Service Table
                        ...
                        <div class="panel-body">
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tr>
                                    ...
                                    <td>{{ $premierService->uae_phone }}</td>
                                    <td>
                                    ...
                                    <td style="width: 150px">
                                        ...
                                        <a href="{{ route('dataEnterer.PremierService.show',$premierService->id) }}"
                                        ...
                                        <button class="btn btn-danger" onclick="delete_function(this)" value="{{ route('dataEnterer.PremierService.destroy',$premierService) }}"><i class="fa fa-trash"></i> </button>
                                    </td>
                                </tr>
                                @endforeach
