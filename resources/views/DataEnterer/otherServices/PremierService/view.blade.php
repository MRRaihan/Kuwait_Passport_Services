...
@section('print')
    ...
    <h2> {{ env('APP_NAME') }} </h2>
        ...
        Bangladesh Mobile :  {{ $premierService->bd_phone }}
        <div class="padding"></div>

        UAE Phone : {{ $premierService->uae_phone }}
        <div class="padding"></div>
        ...
        Residence Emirates ID / Mobile No : {{ $premierService->residence }}<div class="padding"></div>
