  ...
  <body>
    ...
    <div class="float-right ml-2" style="margin-top: 2px;">
      ...
      @if (isset($excel_export) && $excel_export == true)
          <a class="btn btn-sm  btn-outline-success print-none"  href="{{ route('dataEnterer.otherServicesReport.excelExport',$from_date.'&'.$to_date.'&'.$option.'&'.$excel_export) }}"><i class="fas fa-file-excel"></i>Excel</a>
      @endif
