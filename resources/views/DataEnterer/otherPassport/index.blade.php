...
<div class="content">
    <div class="container">
        ...
        <div class="row text-right">
            <div class="col-sm-12">
                @if($flag)
                <a class="btn btn-success btn-sm" href="{{ route('dataEnterer.otherPassport.create') }}" style="float: right; margin-bottom: 10px;" ><i class=" fa fa-plus"></i>&nbsp;Add New Passport</a>
            @endif
            </div>
        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        <a href="{{ route('dataEnterer.otherPassport.receipt',$otherPassport->id) }}" target="_blank" class="btn btn-success"><i class="fa fa-print"></i>Receipt</a>

                                        <a href="{{ route('dataEnterer.otherPassport.sticker',$otherPassport->id) }}" target="_blank" class="btn btn-warning"><i class="fa fa-print"></i>Sticker</a>

                                        <a href="{{ route('dataEnterer.otherPassport.show',$otherPassport->id) }}" target="_blank" class="btn btn-primary"><i class="fa fa-eye"></i></a>

                                        <a href="{{ route('dataEnterer.otherPassport.edit',$otherPassport) }}" class="btn btn-info"><i class="fa fa-edit"></i></a>

                                        {{-- <button class="btn btn-danger" onclick="delete_function(this)" value="{{ route('dataEnterer.otherPassport.destroy',$otherPassport) }}"><i class="fa fa-trash"></i> </button> --}}
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
