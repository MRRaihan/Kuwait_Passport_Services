    ...
    <div class="content">
        <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body row">
                                ...
                                <div class="col-md-4">
                                    <form class="form-group" method="POST" action="{{ route('dataEnterer.renewPassport.search_by_passport_number') }}">
                                        @csrf
                                        <div class="col-sm-9">
                                ...
                                <div class="col-md-4">
                                    <form class="form-group" method="POST" action="{{ route('dataEnterer.renewPassport.search_by_profession_id') }}">
                                        @csrf
                                        <div class="col-sm-9">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-primary">
                            <div class="panel-body row">
                                <div class="col-md-4">
                                    <form class="form-group" method="POST" action="{{ route('dataEnterer.renewPassport.search_by_new_mrp_passport_no') }}">
                                        @csrf
                                        <div class="col-sm-9">
                                ...
                                <div class="col-md-4">
                                    <form class="form-group" method="POST" action="{{ route('dataEnterer.renewPassport.search_by_bio_enrollment_id') }}">
                                        @csrf
                                        <div class="col-sm-9">
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    @if($flag!=0)
                    <a class="btn btn-success btn-sm" href="{{ route('dataEnterer.renewPassport.createSecond') }}"
                                    ...
                                    @foreach ($renewPassports as $key => $renewPassport)
                                        <tr>
                                            ...
                                            <td style="width: 150px">
                                                ...
                                                <button class="btn btn-success" @if ($renewPassport->is_shifted_to_branch_manager != null) disabled @endif  onclick="shiftToBranchManagerNow(this)" value="{{ route('dataEnterer.renewPassport.shiftToBranchManagerNow', $renewPassport->id) }}">Shift to Branch Manager
                                                ...
                                                <a href="{{ route('dataEnterer.renewPassport.edit', $renewPassport) }}"
                                                    ...
                                                    <a href="{{ route('dataEnterer.serviceAddOn',[$renewPassport->id,"renew-passport"]) }}"
