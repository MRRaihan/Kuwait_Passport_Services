            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Renew Passport Create</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #46bdc6 !important;">
                            <span class="panel-title">Renew Passport Create
                                <!-- Button trigger modal for adding new Category -->
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm" href="{{ route('dataEnterer.renewPassport.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <form action="{{ route('dataEnterer.renewPassport.storeSecond') }}" method="post" id="basic-form"
