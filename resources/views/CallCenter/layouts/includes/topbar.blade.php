<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('callCenter.dashboard') }}" class="logo" style="margin-left: 10px"><img src="{{ asset('assets/call-center/images/call_center.png') }}" style="width: 100%; height: 100%; padding-left: 20px"></a>
            {{-- <a href="{{ route('callCenter.dashboard') }}" class="logo"><img src="{{ asset('assets/call-center/images/admin-2.png') }}" style="width: 100%; height: 55px;" height="28"></a> --}}
            <a href="{{ route('callCenter.dashboard') }}" class="logo-sm"><img src="{{ asset('assets/call-center/images/logo_sm.png') }}" height="36"></a>
        </div>
    </div>
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-header ">
                                <img src="{{asset( Auth::user()->image ?? get_static_option('no_image'))}}" class="img-circle " alt="User Image">
                                <p>
                                    {{ Auth::user()->name }}
                                </p>
                            ...
                            <li class="user-footer">
                                <div class="left">
                                    <a href="{{ route('callCenter.profile') }}">
