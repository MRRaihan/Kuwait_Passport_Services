            ...
            <div class="col-sm-12">
                <div class="page-header-title">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{ route('callCenter.dashboard') }}">Call Center Panel</a></li>
                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            ...
                            <h1 class="profile-name">{{ $user->name }} <a class="btn btn-success" href="{{ route('callCenter.editProfile') }}"><i class="fa fa-edit"></i> Edit Profile </a></h1>
                        </div>
                        <div class="row">
                            <ul class="list-group">
