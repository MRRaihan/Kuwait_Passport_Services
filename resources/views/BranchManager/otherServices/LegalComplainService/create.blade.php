            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Legal and Complaints Service Create</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #01ba9a !important;">
                            <span class="panel-title">Legal and Complaints Service Create
                                <!-- Button trigger modal for adding new Category -->
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm"
                                        href="{{ route('branchManager.legalComplaintsService.index') }}"
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <form action="{{ route('branchManager.legalComplaintsService.store') }}" method="post" id="basic-form"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input value='{{ old('uae_phone') }}' class="form-control datepicker"
