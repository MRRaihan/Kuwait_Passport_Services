            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Premier Service Create</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                            ...
                            <span class="panel-title">Premier Service Create
                                ...
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm"
                                        href="{{ route('branchManager.PremierService.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <div class="row">
                                    <form action="{{ route('branchManager.PremierService.store') }}" method="post" id="basic-form"
