                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #01ba9a !important;">
                            <span class="panel-title">Others Service Create
                                ...
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm" href="{{ route('branchManager.otherService.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <form action="{{ route('branchManager.otherService.store') }}" method="post" id="basic-form"
