            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading" style="background-color: #01ba9a !important;">
                        <span class="panel-title">Edit Others Passport
                        <!-- Button trigger modal for adding new Category -->
                        <div class="col-sm-12">
                            <a class="btn btn-warning btn-sm" href="{{ route('branchManager.otherService.index') }}" style="float: right; margin-bottom: 10px; margin-top:-26px;" ><i class="ion-chevron-left"></i>&nbsp; Back</a>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        <form action="{{ route('branchManager.otherService.update',$otherService) }}" method="post" id="basic-form" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                <!-----fast col start------>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="emirates_id" value="{{ $otherService->emirates_id }}" class="form-control" placeholder="Enter Emirates ID" id="emirates_id" autocomplete="off" required="" aria-required="true">
                                    @error('emirates_id')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="residence" value="{{ $otherService->residence }}" type="text" class="form-control" placeholder="Enter Residence Emirates ID / phone No " id="residence">
                                    @error('residence')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
