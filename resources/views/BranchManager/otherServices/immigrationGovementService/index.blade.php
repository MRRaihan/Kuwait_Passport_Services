    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    @if ($flag != 0)
                    <a class="btn btn-success btn-sm" href="{{ route('branchManager.immigrationGovementService.create') }}"
                        ...
                        <div class="panel-body">
                            ...
                            <tr>
                                ...
                                <td style="width: 150px">
                                    ...
                                    <a href="{{ route('branchManager.immigrationGovementService.show',$immigrationService->id) }}"
                                    ...
                                    <button class="btn btn-danger" onclick="delete_function(this)" value="{{ route('branchManager.immigrationGovementService.destroy',$immigrationService) }}"><i class="fa fa-trash"></i> </button>
                                </td>
                            </tr>
                            @endforeach
