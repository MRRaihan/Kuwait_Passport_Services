            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Renew Passport Review</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #01ba9a !important;">
                            <span class="panel-title">Renew Passport Review
                                <!-- Button trigger modal for adding new Category -->
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm" href="{{ route('branchManager.userRenewPassport.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <form action="{{ route('branchManager.renewPassport.update', $renewPassport->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="passport_type_id" name="passport_type_id">
                                                    ...
                                                    @foreach ($renewPassportFees as $passportFee)
                                                        <option {{ $passportFee->id == $renewPassport->passport_type_id ? 'selected' : '' }} value="{{ $passportFee->id }}" @if ($renewPassport->passport_type_id == $passportFee->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                @if($renewPassport->profession_file)
                                                    <a href="{{ asset($renewPassport->profession_file) }}" target="_blank">View old file</a><br>
                                                @endif
                                                <a id="profession_file" href="#" target="">{{ $renewPassport->profession_file ? '' : 'No File Found' }}</a>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="expiry_date" value="{{ $renewPassport->delivery_date == null ? '' : \Carbon\Carbon::parse($renewPassport->expiry_date)->format('Y-m-d') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="dob" value="{{ $renewPassport->dob == null ? '' : \Carbon\Carbon::parse($renewPassport->dob)->format('Y-m-d') }}"
                                                    class="form-control" type="date">
                                                @error('dob')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value='{{ $renewPassport->extended_to == null ? '' : \Carbon\Carbon::parse($renewPassport->extended_to)->format('Y-m-d') }}' name="extended_to" type="date"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value='{{ $renewPassport->delivery_date == null ? '' : \Carbon\Carbon::parse($renewPassport->delivery_date)->format('Y-m-d') }}' class="form-control datepicker"
                                            ...
                                            <div class="form-group" style="margin-top: 100px">
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="active" value="1" {{ $renewPassport->status == 1 ? 'checked' : '' }} name="status">
                                                    <label for="active"> Approved </label>
                                                </div>
                                                <div class="radio radio-danger radio-inline">
                                                    <input type="radio" id="Inactive" value="0" name="status" {{ $renewPassport->status == 0 ? 'checked' : '' }}>
