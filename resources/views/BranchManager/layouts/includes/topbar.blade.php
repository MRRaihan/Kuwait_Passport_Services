<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('branchManager.dashboard') }}" class="logo"><img src="{{ asset('assets/branch-manager/images/branch_manager.png') }}" style="width: 75%; height: 75%;"></a>
            {{-- <a href="{{ route('branchManager.dashboard') }}" class="logo"><img src="{{ asset('assets/branch-manager/images/manager-admin-2.png') }}" style="width: 100%; height: 55px;" height="28"></a> --}}
            <a href="{{ route('branchManager.dashboard') }}" class="logo-sm"><img src="{{ asset('assets/branch-manager/images/logo_sm.png') }}" height="36"></a>
        </div>
    </div>
                    ...
                    <li class="nav-item dropdown user-menu">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                            ...
                            <li class="user-footer">
                                <div class="left">
                                    <a href="{{ route('branchManager.profile') }}">
