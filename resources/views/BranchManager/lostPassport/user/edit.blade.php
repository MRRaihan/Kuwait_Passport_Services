                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                            ...
                            <span class="panel-title">Manual Passport Review</span>
                                ...
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm"
                                        href="{{ route('branchManager.userLostPassport.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <form action="{{ route('branchManager.lostPassport.update', $lostPassport->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="passport_type_id" name="passport_type_id">
                                                    ...
                                                    @foreach ($lostPassportFees as $passportFee)
                                                        <option {{ $passportFee->id == $lostPassport->passport_type_id ? 'selected' : '' }} value="{{ $passportFee->id }}" @if ($lostPassport->passport_type_id == $passportFee->id) selected @endif>
                                            ...
                                            <div class="form-group">
                                                @if($lostPassport->profession_file)
                                                    <a href="{{ asset($lostPassport->profession_file) }}" target="_blank">View old file</a><br>
                                                @endif
                                                <a id="profession_file" href="#" target="">{{ $lostPassport->profession_file ? '' : 'No File Found' }}</a>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                @if($lostPassport->application_form)
                                                    <a href="{{ asset($lostPassport->application_form) }}" target="_blank">View File</a>
                                                @else
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="expiry_date" value="{{ $lostPassport->expiry_date == null ? '' : \Carbon\Carbon::parse($lostPassport->expiry_date)->format('Y-m-d') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="dob" value="{{ $lostPassport->dob == null ? '' : \Carbon\Carbon::parse($lostPassport->dob)->format('Y-m-d') }}"
                                                    class="form-control" type="date">
                                                @error('dob')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value='{{ $lostPassport->extended_to == null ? '' : \Carbon\Carbon::parse($lostPassport->extended_to)->format('Y-m-d') }}' name="extended_to" type="date"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value='{{ $lostPassport->delivery_date == null ? '' : \Carbon\Carbon::parse($lostPassport->delivery_date)->format('Y-m-d') }}' class="form-control datepicker"
                                            ...
                                            <div class="form-group" style="margin-top: 100px">
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="active" value="1" {{ $lostPassport->status == 1 ? 'checked' : '' }} name="status">
                                                    <label for="active"> Approved </label>
                                                </div>
                                                <div class="radio radio-danger radio-inline">
                                                    <input type="radio" id="Inactive" value="0" name="status" {{ $lostPassport->status == 0 ? 'checked' : '' }}>
