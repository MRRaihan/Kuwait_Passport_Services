    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Passport</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body row">
                            ...
                            <div class="col-md-4">
                                <form class="form-group" method="POST" action="{{ route('branchManager.lostPassport.search_by_emirats') }}">
                                    @csrf
                                    <div class="col-sm-9">
                            ...
                            <div class="col-md-4">
                                <form class="form-group" method="POST" action="{{ route('branchManager.lostPassport.searchByMrpPassportNo') }}">
                                    @csrf
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" id="mrp_passport" placeholder="Search by MRP Passport No." name="mrp_no">
                                    </div>
                                    <button type="submit" class="col-sm-3 btn btn-success">Search</button>
                                </form>
                            </div>
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    @if ($flag != 0)
                        <a class="btn btn-success btn-sm" href="{{ route('branchManager.lostPassport.createSecond') }}"
                                            ...
                                            <td style="width: 150px">
                                                ...
                                                <a href="{{ route('branchManager.lostPassport.show', $lostPassport->id) }}"
                                                    target="_blank" class="btn btn-primary"><i
                                                        class="fa fa-eye"></i></a>
                                                @if ($lostPassport->is_shifted_to_branch_manager == 1)
                                                    <button class="btn btn-warning" onclick="dismissComplain(this)"
                                                    value="{{ route('branchManager.lostPassport.dismissComplain', $lostPassport->id) }}"><i class="fa fa-check-square-o"></i>Dismiss Complain
                                                    </button>
                                                @endif
                                                ...
                                                <a href="{{ route('branchManager.serviceAddOn',[$lostPassport->id,"lost-passport"]) }}"
