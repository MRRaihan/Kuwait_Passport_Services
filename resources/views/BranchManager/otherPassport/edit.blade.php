            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading" style="background-color: #01ba9a !important;">
                        ...
                        <div class="col-sm-12">
                            <a class="btn btn-warning btn-sm" href="{{ route('branchManager.otherPassport.index') }}" style="float: right; margin-bottom: 10px; margin-top:-26px;" ><i class="ion-chevron-left"></i>&nbsp; Back</a>
                        </div>
                    </div>
                    ...
                    <div class="box-body">
                        <form action="{{ route('branchManager.otherPassport.update',$otherPassport) }}" method="post" id="basic-form" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                <!-----fast col start------>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="emirates_id" value="{{ $otherPassport->emirates_id }}" class="form-control" placeholder="Enter Emirates ID" id="emirates_id" autocomplete="off" required="" aria-required="true">
                                    @error('emirates_id')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value='{{  $otherPassport->uae_phone }}' class="form-control datepicker" name="uae_phone" type="text" placeholder="Kuwait Phone" id="uae_phone" value="" autocomplete="off">
                                    @error('uae_phone')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                {{-- <div class="form-group">
                                    ...
                                    <select class="form-control" id="salary" name="delivery_branch">
                                        @foreach ($branchs as $key => $branch)
                                            <option value="{{ $branch->id }}" @if ($otherPassport->delivery_branch == $branch->id) selected @endif>
                                                {{ $branch->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('salary')
