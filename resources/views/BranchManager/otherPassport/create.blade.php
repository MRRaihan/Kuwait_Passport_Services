        ...
        <div class="row mt-5">
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <div class="box-body">
                        <form action="{{ route('branchManager.otherPassport.store') }}" method="post" id="basic-form" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="emirates_id" value='{{ old('emirates_id') }}' class="form-control" placeholder="Enter Emirates ID" id="emirates_id" autocomplete="off" required="" aria-required="true">
                                    @error('emirates_id')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="salary" value='{{ old('salary') }}' name="salary">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input value='{{ old('uae_phone') }}' class="form-control datepicker" name="uae_phone" type="text" placeholder="Kuwait Phone" id="uae_phone" value="" autocomplete="off">
                                    @error('uae_phone')
                                    <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
