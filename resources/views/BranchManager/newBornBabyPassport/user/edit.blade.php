                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                @if($newBornBabyPassport->profession_file)
                                                    <a href="{{ asset($newBornBabyPassport->profession_file) }}" target="_blank">View old file</a><br>
                                                @endif
                                                <a id="profession_file" href="#" target="">{{ $newBornBabyPassport->profession_file ? '' : 'No File Found' }}</a>
                                            </div>
                                            <div class="form-group">
