...
<div class="content">
    <div class="container">
            ...
            <div class="col-sm-12">
                <div class="page-header-title">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{ route('branchManager.dashboard') }}">Admin Panel</a></li>
        ...
        <div class="row text-right">
            <div class="col-sm-12">
                ...
                <div class="col-md-2" style="margin-top: 25px;">
                    <a class="btn btn-md btn-block text-white" onclick="searchOptions()" style="background-color:#01ba9a"><i class="fa fa-search"></i>&nbsp;Search</a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-5" style="margin-top: 20px;">
            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="panel-heading" style="background-color: #01ba9a; color:white!important;">
