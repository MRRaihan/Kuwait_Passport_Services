            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">User Manual Passport Review</h4>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                            ...
                            <span class="panel-title">Manual Passport Review
                                ...
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm"
                                        href="{{ route('branchManager.userManualPassport.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <form action="{{ route('branchManager.manualPassport.update', $manualPassport->id) }}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="expiry_date" value="{{ $manualPassport->expiry_date == null ? '' : \Carbon\Carbon::parse($manualPassport->expiry_date)->format('Y-m-d') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="dob" value="{{ $manualPassport->dob == null ? '' : \Carbon\Carbon::parse($manualPassport->dob)->format('Y-m-d') }}"
                                                    class="form-control" type="date">
                                                @error('dob')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input name="emirates_id" value='{{ $manualPassport->emirates_id }}' class="form-control"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="uae_phone" value='{{ $manualPassport->uae_phone }}' type="text"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value='{{ $manualPassport->extended_to == null ? '' : \Carbon\Carbon::parse($manualPassport->extended_to)->format('Y-m-d') }}' name="extended_to" type="date"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input value='{{ $manualPassport->delivery_date == null ? '' : \Carbon\Carbon::parse($manualPassport->delivery_date)->format('Y-m-d') }}' class="form-control datepicker"
                                            ...
                                            <div class="form-group" style="margin-top: 100px">
                                                <div class="radio radio-info radio-inline">
                                                    <input type="radio" id="active" value="1" {{ $manualPassport->status == 1 ? 'checked' : '' }} name="status">
                                                    <label for="active"> Approved </label>
                                                </div>
                                                <div class="radio radio-danger radio-inline">
                                                    <input type="radio" id="Inactive" value="0" name="status" {{ $manualPassport->status == 0 ? 'checked' : '' }}>
