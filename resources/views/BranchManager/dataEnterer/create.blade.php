<form action="javascript:void(0)" method="POST" >
        ...
        <button type="submit" id="btnAddDataEnterer" class="btn btn-info">Add Data Enterer</button>
</form>

<script>
    $(document).ready(function() {
        $('#btnAddDataEnterer').click(function() {
            ...
            $.ajax({
                method: 'POST',
                url: "{{ route('branchManager.dataEnterer.store') }}",
                headers: {
