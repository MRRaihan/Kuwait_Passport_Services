<form enctype="multipart/form-data" id="edit-form">
    ...
    <button type="submit" id="btnUpdateDataEnterer" class="btn btn-info">Update Data Enterer</button>
  ...
  <script>
    ...
    //  console.log(formData);
     ...
     $.ajax({
         url: "{{ route('branchManager.dataEnterer.update',$enterer->id) }}",// your request url
         data: formData,
         processData: false,
         contentType: false,
         type: 'POST',
