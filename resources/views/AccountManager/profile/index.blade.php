                ...
                <div class="panel panel-success">
                    ...
                    <div class="panel-body">
                        <div class="text-center">
                            <img height="200px;" width="200px;" class="card-img profile-card-image" src="{{ asset($user->image ?? get_static_option('no_image')) }}" alt="Card image cap">
                            <h1 class="profile-name">{{ $user->name }} <a class="btn btn-success" href="{{ route('accountManager.editProfile') }}"><i class="fa fa-edit"></i> Edit Profile </a></h1>
