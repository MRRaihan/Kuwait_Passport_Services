...
<div class="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('accountManager.updateProfile') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @include('Others.message')
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #0C2F66">
