                ...
                @if (isset($passports[0]))
                    @foreach ($passports as $key => $passport)
                        <tr>
                          ...
                          <td><a href="{{ route('accountManager.renewPassport.show', $passport->id) }}" target="_blank">view</a></td>
                          @endif
                          @if ($passport->model_name == 'Manual Passport')
                            <td><a href="{{ route('accountManager.manualPassport.show', $passport->id) }}" target="_blank">view</a></td>
                          @endif
                          @if ($passport->model_name == 'Lost Passport')
                            <td><a href="{{ route('accountManager.lostPassport.show', $passport->id) }}" target="_blank">view</a></td>
                          @endif
                          @if ($passport->model_name == 'Other Passport')
                            <td><a href="{{ route('accountManager.lostPassport.show', $passport->id) }}" target="_blank">view</a></td>
                          @endif
                          @if ($passport->model_name == 'New Born Baby Passport')
                            <td><a href="{{ route('accountManager.newBornBabyPassport.show', $passport->id) }}" target="_blank">view</a></td>
                          @endif --}}
