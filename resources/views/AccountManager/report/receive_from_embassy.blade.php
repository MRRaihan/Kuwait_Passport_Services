    ...
    <div class="container">
        ...
        <div class="row text-left">
            <div class="panel bg-info">
                <h4 class="pull-left page-title">&nbsp;&nbsp;Date Wise Receive To Embassy Report</h4>
                <div class="clearfix"></div>
            </div>
...
<script>
    ...
    function searchOptions() {
          window.open("{{ url('account-manager/receive-from-embassy-report') }}/"+$('#from_date').val()+"&"+$('#to_date').val()+"&"+$('#branch_id').val()+"&"+$('#option_id').val(),"_blank");
    }
</script>
