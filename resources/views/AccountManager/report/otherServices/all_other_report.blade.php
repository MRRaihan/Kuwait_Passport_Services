            ...
            <div class="col-sm-12">
                <div class="page-header-title">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{ route('accountManager.dashboard') }}">Admin Panel</a></li>
                ...
                <div class="row">
                    <div class="col-md-3" style="margin-bottom: 10px;">
                        ...
                        <select class="form-control" name="branch_id_search" id="branch_id_search"
                            onchange="openLink('{{ url('account-manager/all-other-services-report') }}/'+$('#branch_id_search').val())">
                            <option value="0">&nbsp;&nbsp;&nbsp;&nbsp;All Branch</option>
                            @if (isset($branches[0]))
                                @foreach ($branches as $key => $branch)
...
<script>
    ...
    function otherServicesReport() {
          window.open("{{ url('account-manager/other-services-report') }}/"+$('#from_date').val()+"&"+$('#to_date').val()+"&"+$('#branch_id').val()+"&"+$('#option_id').val(),"_blank");
    }
</script>
