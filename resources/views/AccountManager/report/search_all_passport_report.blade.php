...
@section('report_body')
    ...
    <div class="float-right ml-2 mt-3 mr-3" style="margin-top: 2px;">
      ...
      <a class="btn btn-sm  btn-outline-success print-none"  href="{{ route('accountManager.allPassportReport.excelExport',$from_date.'&'.$to_date.'&'.$branch_id.'&'.$option) }}"><i class="fas fa-file-excel"></i> Excel</a>
    </div>
