...
<div class="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Add Services</h4>
        ...
        <form action="{{ route('admin.pageServices.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" class="form-control" name="title" value="{{ old('title') }}" placeholder="Service Title">
                        @error('title')
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Logo</label>
                        <input type="file" class="form-control" name="logo" value="{{ old('logo') }}" placeholder="Upload Services Logo">
                        @error('logo')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>URL</label>
                        <input type="text" class="form-control" name="url" value="{{ old('url') }}" placeholder="Service URL">
                        @error('title')
                        <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="col-sm-12" style="margin-bottom: 25px;">
                    ...
                    <textarea id="banner-text" class="summernote form-control banner_text" name="content" rows="9">{!! old('content') !!}</textarea>
                    @error('content')
                    <p class="text-danger">{{ $message }}</p>
                    @enderror
                </div>
