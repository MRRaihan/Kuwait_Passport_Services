...
@section('content')
    ...
    <div class="content">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Edit Pricing Plan</h4>
            ...
            <form action="{{ route('admin.pricingPlan.update',$pricingPlan) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label >Title</label>
                            <input type="text" class="form-control" name="title" value="{{ $pricingPlan->title }}" placeholder="Pricing Plan Title">
                              @error('title')
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="radio radio-info radio-inline">
                            <input type="radio" class="form-control" id="active" value=1 name="status" @if ( $pricingPlan->status == 1) checked="checked" @endif>
                            <label for="active"> Active </label>
                        </div>
                        <div class="radio radio-danger radio-inline">
                            <input type="radio" class="form-control" id="Inactive" value=0 name="status" @if ( $pricingPlan->status == 0) checked="checked" @endif>
                    ...
                    <div class="col-sm-12" style="margin-bottom: 25px;">
                        <div class="row">
                            <div class="col-sm-6">
                                    ...
                                    <textarea id="banner-text1" class="form-control banner_text d-inline" name="content_samary" rows="0">{!! $pricingPlan->content_samary !!}</textarea>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <textarea id="banner-text2" class="form-control banner_text d-inline" name="content_details" rows="0">{!! $pricingPlan->content_details !!}</textarea>
