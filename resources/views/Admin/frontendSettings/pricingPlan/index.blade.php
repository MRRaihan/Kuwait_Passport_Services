            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Pricing List</h4>
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    <a class="btn btn-success btn-sm" style="float: right; margin-bottom: 10px;"
                        href="{{ route('admin.pricingPlan.create') }}"><i
                                ...
                                <tbody>
                                    ...
                                    @foreach ($pricingPlans as $pricingPlan)
                                        <tr>
                                            ...
                                            <td>
                                                {{ \Carbon\Carbon::parse($pricingPlan->created_at)->format('d-m-Y') }}
                                            </td>
                                            </td>
                                            <td style="width: 150px">

                                                <button class="btn btn-danger" onclick="delete_function(this)"
                                                value="{{ route('admin.pricingPlan.destroy', $pricingPlan) }}"><i
                                                    class="fa fa-trash"></i> </button>

                                                <a href="{{ route('admin.pricingPlan.edit',$pricingPlan->id) }}" class="btn btn-info"><i class="fa fa-edit"></i></a>
