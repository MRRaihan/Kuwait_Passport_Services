            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Profession List</h4>
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    <a class="btn btn-success btn-sm" style="float: right; margin-bottom: 10px;"
                        onclick="Show('Add Profession','{{ route('admin.profession.create') }}')"><i
                            class=" fa fa-plus"></i>&nbsp;Add New Profession</a>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <span class="panel-title">Profession List
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <?php $sl = 1; ?>
                                    @foreach ($professions as $profession)
                                        <tr>
                                            <td>{{$sl}}</td>
                                            <td>{{ $profession->name }} {{ $profession->last_name }}</td>
                                            </td>
                                            <td>
                                            ...
                                            <td style="width: 150px">
                                                @if ($profession->status == 0)
                                                    <button class="btn btn-success" onclick="activeNow(this)"
                                                        value="{{ route('admin.profession.activeNow', $profession->id) }}">
                                                        <i class="mdi mdi-check"></i>
                                                    </button>
                                                @elseif($profession->status == 1)
                                                    <button class="btn btn-danger" onclick="inactiveNow(this)"
                                                        value="{{ route('admin.profession.inactiveNow', $profession->id) }}">
                                                        <i class="mdi mdi-close"></i>
                                                    </button>
                                                @endif
                                                <a onclick="Show('{{ $profession->name }} Edit','{{ route('admin.profession.edit', $profession->id) }}',)"
