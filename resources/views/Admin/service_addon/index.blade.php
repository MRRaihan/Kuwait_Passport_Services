                ...
                <div class="col-sm-12">
                    <div class="page-header-title">
                        ...
                        <ol class="breadcrumb pull-right">
                            <li><a href="{{ route('branchManager.dashboard') }}">Manager Admin Panel</a></li>
                ...
                <div class="col-lg-12">
                    <ul class="nav nav-tabs navtab-bg ">
                        <li class="active">
                            <a href="#allService" data-toggle="tab" aria-expanded="false">
                                ...
                                <span class="hidden-xs">All Service</span>
                            </a>
                        </li>
                        <li class="">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="premiem">
                            <div class="row">
                                <form action="{{ route('admin.addExtraService.store') }}" method="post" id="basic-form"
