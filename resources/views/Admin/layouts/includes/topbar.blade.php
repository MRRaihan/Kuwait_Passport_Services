<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('admin.dashboard') }}" style="margin-left: 20px;" class="logo"><img src="{{ asset('assets/admin/images/admin.png') }}" style="width: 100%; height: 100%; padding-left: 30px" height="28"></a>
            {{-- <a href="{{ route('admin.dashboard') }}" class="logo"><img src="{{ asset('assets/admin/images/admin-2.png') }}" style="width: 100%; height: 55px;" height="28"></a> --}}
