<form action="javascript:void(0)" method="POST" id="branch_add">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Delivery Name">
        <br>
        <label for="cost">Cost</label>
        <input type="number" class="form-control" id="cost" name="cost" placeholder="Cost">
        <b>Delivery Cost</b><br>
        <br>
    ...
    <button type="submit" id="btnSaveDelivery" class="btn btn-info">Save Delivery</button>
