                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <span class="panel-title">New Born Baby Passport Create
                                ...
                                <div class="col-sm-12">
                                    <a class="btn btn-warning btn-sm" href="{{ route('admin.newBornBabyPassport.index') }}"
                        ...
                        <div class="panel-body">
                            <div class="box-body">
                                <form action="{{ route('admin.newBornBabyPassport.storeSecond') }}" method="post" id="basic-form"
