            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-body row">
                        <div class="col-md-4">
                            <form class="form-group" method="POST" action="{{ route('admin.newBornBabyPassport.search_by_civil') }}">
                                @csrf
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-4">
                            <form class="form-group" method="POST" action="{{ route('admin.newBornBabyPassport.search_by_new_mrp_passport_no') }}">
                                @csrf
                                <div class="col-sm-9">
                        ...
                        <div class="col-md-4">
                            <form class="form-group" method="POST" action="{{ route('admin.newBornBabyPassport.search_by_bio_enrollment_id') }}">
                                @csrf
                                <div class="col-sm-9">
