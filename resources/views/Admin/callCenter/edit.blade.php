<form enctype="multipart/form-data" id="edit-form">
    ...
    <button type="submit" id="btnUpdateEmploy" class="btn btn-info">Update Call Center Employee</button>


  </form>

  <script>
    $(document).on('click','#btnUpdateEmploy',function (event) {
    ...
    //  console.log(formData);
     ...
     $.ajax({
         url: "{{ route('admin.callCenter.update',$user->id) }}",// your request url
         data: formData,
         processData: false,
         contentType: false,
         type: 'POST',
