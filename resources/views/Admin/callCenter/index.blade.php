...
<div class="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Call Center List</h4>
        ...
        <div class="row text-right">
            <div class="col-sm-12">
                <a class="btn btn-success btn-sm" style="float: right; margin-bottom: 10px;" onclick="Show('New Call Center Employ','{{ route('admin.callCenter.create') }}')"><i class=" fa fa-plus"></i>&nbsp;New Call Center</a>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <span class="panel-title">Call Center list
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        @if ($callCenter->status == 0)
                                            <button class="btn btn-success" onclick="activeNow(this)" value="{{ route('admin.callCenter.activeNow', $callCenter->id) }}">
                                                <i class="mdi mdi-check"></i>
                                            </button>
                                        @elseif($callCenter->status == 1)
                                            <button class="btn btn-danger" onclick="inactiveNow(this)" value="{{ route('admin.callCenter.inactiveNow', $callCenter->id) }}">
                                                <i class="mdi mdi-close"></i>
                                            </button>
                                        @endif
                                        <a onclick="Show('{{ $callCenter->name }} Edit','{{ route('admin.callCenter.edit',$callCenter->id) }}',)" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                        <button class="btn btn-danger" onclick="delete_function(this)" value="{{ route('admin.callCenter.destroy',$callCenter) }}"><i class="fa fa-trash"></i> </button>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
