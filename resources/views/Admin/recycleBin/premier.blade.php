                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                                ...
                                <tbody>
                                    @foreach ($premierServices as $premierService)
                                        <tr>
                                            ...
                                            <td style="width: 150px">
                                                <button class="btn btn-info" onclick="restore(this)"
                                                    value="{{ route('admin.recycleBin.other.otherServiceRestore',$premierService->id.'&'.'0') }}"><i class="mdi mdi-backup-restore"></i> Restore
                                                </button>
                                                <button class="btn btn-danger" onclick="permanent_delete(this)"
                                                    value="{{ route('admin.recycleBin.other.otherServicePermanentDelete',$premierService->id.'&'.'0') }}"><i class="fa fa-trash"></i> Delete Permanently
                                                </button>
                                            </td>
                                        </tr>
                                    @endforeach
