        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Manual Passports</h4>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <span class="panel-title">Manual Passports Table</span>
                        ...
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if($manualPassport->deleted_by != 1)
                                        <td>Branch Manager({{ $manualPassport->deletor->name }})</td>
                                    @else
                                        <td>{{ $manualPassport->deletor->name }}</td>
                                    @endif
                                    <td style="width: 150px">
                                        <button class="btn btn-info" onclick="restore(this)"
                                            value="{{ route('admin.manualPassport.restore', $manualPassport->id) }}"><i class="mdi mdi-backup-restore"></i> Restore
                                        </button>
                                        <button class="btn btn-danger" onclick="permanent_delete(this)"
                                            value="{{ route('admin.manualPassport.permanentDelete', $manualPassport->id) }}"><i class="fa fa-trash"></i> Delete Permanently
                                        </button>
                                    </td>
                                </tr>
                                @endforeach
