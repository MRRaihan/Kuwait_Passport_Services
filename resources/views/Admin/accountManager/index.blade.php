...
<div class="content">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Account Manager</h4>
        ...
        <div class="row text-right">
            <div class="col-sm-12">
                <a class="btn btn-success btn-sm" style="float: right; margin-bottom: 10px;" onclick="Show('New Accounts Manager','{{ route('admin.accountManager.create') }}')"><i class=" fa fa-plus"></i>&nbsp;New Account Manager</a>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <span class="panel-title">Account Manager List
                    ...
                    <div class="panel-body">
                        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                            <?php $sl = 1; ?>
                                @foreach ($accountManagers as $data)
                                <tr>
                                    <td>{{$sl}}</td>
                                    ...
                                    <td style="width: 150px">
                                        ...
                                        @if ($data->status == 0)
                                            <button class="btn btn-success" onclick="activeNow(this)" value="{{ route('admin.accountManager.activeNow', $data->id) }}">
                                                <i class="mdi mdi-check"></i>
                                            </button>
                                        @elseif($data->status == 1)
                                            <button class="btn btn-danger" onclick="inactiveNow(this)" value="{{ route('admin.accountManager.inactiveNow', $data->id) }}">
                                                <i class="mdi mdi-close"></i>
                                            </button>
                                        @endif

                                        <a onclick="Show('{{ $data->name }} Edit','{{ route('admin.accountManager.edit',$data->id) }}',)" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                        <button class="btn btn-danger" onclick="delete_function(this)" value="{{ route('admin.accountManager.destroy',$data) }}"><i class="fa fa-trash"></i> </button>
                                    </td>
                                </tr>
                                <?php $sl++; ?>
                                @endforeach
