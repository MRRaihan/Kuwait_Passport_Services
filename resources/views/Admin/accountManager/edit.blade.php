<form enctype="multipart/form-data" id="edit-form">
    ...
    <button type="submit" id="btnUpdateAccountManager" class="btn btn-info">Update Account Manager</button>
  ...
  <script>
    ...
    //  console.log(formData);
     ...
     $.ajax({
         url: "{{ route('admin.accountManager.update',$user->id) }}",// your request url
         data: formData,
         processData: false,
         contentType: false,
         type: 'POST',
