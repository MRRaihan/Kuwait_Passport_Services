                    ...
                    <div class="panel-body">
                            ...
                            <div class="row" style="margin-bottom: 20px;">
                                <div class="col-md-3" >
                                    ...
                                    <select class="form-control" name="onchange_option_id" id="onchange_option_id" onchange="openLink('{{ url('admin/passport-options/delivery-from-branch') }}/'+'&'+'&'+'&'+'&'+$('#onchange_option_id').val())">
                                        @if(passportOptions()[0])
                                        @foreach (passportOptions() as $key => $passort)
                                            <option value="{{$key}}"   {{ $option == $key ? 'selected' : '' }}   >&nbsp;&nbsp;&nbsp;&nbsp;{{$passort}}</option>
                                        @endforeach
                            ...
                            <table id="datatable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                {{-- <center><button type="submit" class="btn btn-md btn-info">Delivery</button></center> --}}
                                <thead>
                                    <tr>
                                        <th>
                                            <label>
                                                <input type="checkbox" name="select_option" id="select_option" onclick="checkedAll.call(this);">&nbsp;Select All / Unsellect All
                                            </label>
                                        </th>
                                        <th>Name</th>
                                        <th>Emirates ID</th>
...
<script>
    function searchOptions() {
         window.open("{{ url('admin/passport-options/delivery-from-branch') }}/"+$('#emirates_id').val()+"&"+$('#mobile').val()+"&"+$('#from_date').val()+"&"+$('#to_date').val()+"&"+$('#option_id').val(),"_parent");
    }
