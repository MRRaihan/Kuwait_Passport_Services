...
<div class="content">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-header-title">
                    <h4 class="pull-left page-title">Branch Manager Report</h4>
        ...
        <div class="row">
            @foreach($dataEntriers as $key => $value)
                    ...
                    <div class="panel panel-primary text-center">
                        @if($key%2 == 0)
                            <div class="panel-heading" style="background: rgba(96,183,54,0.82);">
                                <h4 class="panel-title">Data Entry Profile</h4>
                            </div>
                        @else
                        ...
                        <div class="panel-body">
                            ...
                            <div class="user-info">
                                ...
                                <hr>
                                <p>
                                    <a href="{{ route('admin.seeDataEntryReport',$value->id) }}" target="__blank" class="btn btn-primary"><i class="fa fa-eye" title="View Profile"></i></a>

                                    @if ($value->entry_status == 0)
                                        <button class="btn btn-success" onclick="activeNow(this)" value="{{ route('admin.dataEnterer.entryActiveNow',$value->id) }}">
                                            <i class="mdi mdi-check"></i>
                                        </button>
                                        @elseif($value->entry_status == 1)
                                        <button class="btn btn-danger" onclick="inactiveNow(this)" value="{{ route('admin.dataEnterer.entryInactiveNow',$value->id) }}">
