...
<div class="content">
    <div class="container">
        ...
        <div class="row text-right">
            <div class="col-sm-12">
                <a class="btn btn-success btn-sm" style="float: right; margin-bottom: 10px;" onclick="Show('New Branch Manager','{{ route('admin.branchManager.create') }}')"><i class=" fa fa-plus"></i>&nbsp;New Branch Manager</a>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <span class="panel-title">Branch Manager List
                            ...
                            <?php $sl = 1; ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 150px">
                                        @if ($branchManager->status == 0)
                                        <button class="btn btn-success" onclick="activeNow(this)" value="{{ route('admin.branchManager.activeNow',$branchManager->id) }}">
                                            <i class="mdi mdi-check"></i>
                                        </button>
                                        @elseif($branchManager->status == 1)
                                        <button class="btn btn-danger" onclick="inactiveNow(this)" value="{{ route('admin.branchManager.inactiveNow',$branchManager->id) }}">
                                            <i class="mdi mdi-close"></i>
                                        </button>
                                        @endif
                                        <a onclick="Show('{{$branchManager->name }} Edit','{{ route('admin.branchManager.edit',$branchManager->id) }}',)" class="btn btn-info"><i class="fa fa-edit"></i></a>
