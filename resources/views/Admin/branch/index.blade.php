            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-header-title">
                        <h4 class="pull-left page-title">Branch List</h4>
            ...
            <div class="row text-right">
                <div class="col-sm-12">
                    <a class="btn btn-success btn-sm" style="float: right; margin-bottom: 10px;"
                        onclick="Show('Add Branch','{{ route('admin.branch.create') }}')"><i
                                            ...
                                            <td style="width: 150px">
                                                @if ($branch->status == 0)
                                                    <button class="btn btn-success" onclick="activeNow(this)"
                                                        value="{{ route('admin.branch.activeNow', $branch->id) }}">
                                                        <i class="mdi mdi-check"></i>
                                                    </button>
                                                @elseif($branch->status == 1)
                                                    <button class="btn btn-danger" onclick="inactiveNow(this)"
                                                        value="{{ route('admin.branch.inactiveNow', $branch->id) }}">
                                                        <i class="mdi mdi-close"></i>
                                                    </button>
                                                @endif
                                                <a onclick="Show('{{ $branch->name }} Edit','{{ route('admin.branch.edit', $branch->id) }}',)"
