           ...
           <div class="col-md-10 col-md-offset-4">
               <div class="row">
                <div class="col-md-3" style="margin-bottom: 10px;">
                    ...
                    <select class="form-control" name="branch_id_search" id="branch_id_search" onchange="openLink('{{ url('admin/report') }}/'+$('#branch_id_search').val())">
                        <option value="0">&nbsp;&nbsp;&nbsp;&nbsp;All Branch</option>
                        @if(isset($branches[0]))
                        @foreach ($branches as $key => $branch)
...
<script>
    ...
    function searchOptions() {
          window.open("{{ url('admin/get-report') }}/"+$('#from_date').val()+"&"+$('#to_date').val()+"&"+$('#branch_id').val()+"&"+$('#option_id').val(),"_blank");
    }

    function otherServicesReport() {
          window.open("{{ url('admin/other-services-report') }}/"+$('#other_from_date').val()+"&"+$('#other_to_date').val()+"&"+$('#other_branch_id').val()+"&"+$('#other_option_id').val(),"_blank");
    }
