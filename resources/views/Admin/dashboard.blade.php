                ...
                <div class="col-md-6">
                    <div class="col-md-12">
                        <div class="panel panel-color">
                            <div class="panel-heading" style="text-align: center; background-color: #03a9f4;">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="panel panel-default text-center">
                                                <div class="panel-heading">
                                                    <h4 class="panel-title text-dark"> Branch Manager</h4>
                                                </div>
                                                <div class="panel-body">
                                                    <h3 class=""><b>{{ $totalBranches }}</b></h3>
                                                    <p class="text-muted"><b><a href="{{ route('admin.seeBranchData') }}"
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="panel panel-default text-center">
                                                <div class="panel-heading" style="">
                                                    <h4 class="panel-title text-dark"> Call Center</h4>
                                                </div>
                                                <div class="panel-body">
                                                    <h3 class=""><b>{{ $totalCallCenters }}</b></h3>
                                                    <p class="text-muted"><b><a href="{{ route('admin.callCenter.index') }}"
                                                                                target="__blank"><i class="fa fa-eye"></i> View All</a></b></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="panel panel-default text-center">
                                                <div class="panel-heading" style="">
                                                    <h4 class="panel-title text-dark"> Account Manager</h4>
                                                </div>
                                                <div class="panel-body">
                                                    <h3 class=""><b>{{ $totalAccounts }}</b></h3>
                                                    <p class="text-muted"><b><a href="{{ route('admin.accountManager.index') }}"
                                                                                target="__blank"><i class="fa fa-eye"></i> View All</a></b></p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-lg-6">
                                            <div class="panel panel-default text-center">
                                                <div class="panel-heading" style="">
                                                    <h4 class="panel-title text-dark"> Data Enterer</h4>
                                                </div>
                                                <div class="panel-body">
                                                    <h3 class=""><b>{{ $totalDataEntre }}</b></h3>
                                                    <p class="text-muted"><b><a href="{{ route('admin.dataEnterer.index') }}"
                                                                                target="__blank"><i class="fa fa-eye"></i> View All</a></b></p>
                                                </div>
                                            </div>
                                        </div>
