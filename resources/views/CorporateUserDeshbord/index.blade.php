  ...
  {{-- <div class="col-md-12 py-5">
    ...
    <div class="row">
      ...
      <div class="col-md-3 text-center completeBox m-1">
        <a href="{{ route('service',passportOptionsUsers()[0]) }}">
          <div class="d-flex justify-content-between p-3 ">
            <div class="pt-2 ">
      ...
      <div class="col-md-3 text-center completeBox m-1">
        <a href="{{ route('service',passportOptionsUsers()[1]) }}">
          <div class="d-flex justify-content-between p-3 ">
            <div class="pt-2 ">
      ...
      <div class="col-md-3 text-center completeBox m-1">
        <a href="{{ route('service',passportOptionsUsers()[2]) }}">
          <div class="d-flex justify-content-between p-3 ">
            <div class="pt-2 ">
      ...
      <div class="col-md-3 text-center completeBox m-1">
        <a href="{{ route('service',passportOptionsUsers()[3]) }}">
          <div class="d-flex justify-content-between p-3 ">
            <div class="pt-2 ">
      ...
      <div class="col-md-3 text-center completeBox m-1">
        <a href="{{ route('service',passportOptionsUsers()[4]) }}">
          <div class="d-flex justify-content-between p-3 ">
            <div class="pt-2 ">
