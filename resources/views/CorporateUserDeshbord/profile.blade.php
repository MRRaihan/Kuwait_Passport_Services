...
<div class="col-md-9 p-3">
        <form action="{{ route('corporateUser.profile.updatePost') }}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="row p-5">
              ...
              <div class="col-md-6">
                <div class="first-card mx-auto">
                  ...
                  <div class="my-4">
                    ...
                    <input type="text" class="form-control select-forms" id="exampleFormControlInput1"   name="kuwait_phone" value="{{ $user->kuwait_phone }}"/>
                  </div>
