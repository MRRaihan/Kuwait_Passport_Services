...
@section('passport_service')
    <div class="col-md-4 mb-3">
      ...
      <div class="col-md-8">
        <form action="{{ route('service.update',$type.'&'.$passport->id) }}" method="post" enctype="multipart/form-data">
          @csrf
              ...
              <div class="col-md-6">
                <div class="first-card mx-auto">
                  ...
                  @if ($type == 2)
                    ...
                    <div class="my-4">
                      <label for="gd_report_uae" class="form-label">GD Report (UAE Only PDF)</sup></label>
          ...
          <input type="submit" style="margin-top: 20px;" class="next btn_next_step_1 btn submit-btn1 text-white action-button" value="Update" />
       </form>
    </div>
@endsection
