...
<div class="col-md-8">
  ...
  <div class="row pb-4">
    ...
    <div class="review-inforamtion col-md-8">
      <a href="{{ route('service.status',$type.'&'.$passport->id.'&edit') }}">
      ...
      <div class="py-5">
        ...
        <table class="review-infomation-container ">
            ...
            <tr class="review-infomation-item">
              <td class="custom-label">Mobile number<span class="county-phone">BD</span></td>
              <td>{{ $passport->bd_phone }}</td>
            </tr>
            <tr class="review-infomation-item">
              <td class="custom-label">Mobile number<span class="county-phone">UAE</span></td>
            ...
            <tr class="review-infomation-item">
              <td class="custom-label">Delivery Method</td>
              <td>{{ $passport->passportDelivery ? $passport->passportDelivery->delivery ? $passport->passportDelivery->delivery->name : '' : '' }}</td>
            </tr>
    ...
    <div class="review-payment-status col-md-8">
      <div id="reload" class="infor-edit">
  ...
  <a class="btn btn-md previous btn_step_2 action-button-previous"  href="{{ route('service.status',$type.'&'.$passport->id.'&edit') }}"> <i class="fa fa-arrow-left text-white"></i> Previous</a>
  @if ($passport->status == 1)
    <a href="{{ route('service.payment',$type.'&'.$passport->id) }}" style="margin-left: 31%" class="next rounded-pill px-5 btn badge-pill btn-primary action-button"> Next <i class="fa fa-arrow-right text-white"></i>
    </a>
  @endif
