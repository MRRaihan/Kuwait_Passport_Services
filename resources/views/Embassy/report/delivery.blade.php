        ...
        <div class="row text-left">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-md-2" style="margin-top: 25px;">
                    <a class="btn btn-success btn-md btn-block text-white" onclick="searchOptions()"><i class="fa fa-search"></i>&nbsp;View Report</a>
                </div>
            </div>
        </div>
...
<script>
    ...
    function searchOptions() {
          window.open("{{ url('embassy/delivery-report') }}/"+$('#from_date').val()+"&"+$('#to_date').val()+"&"+$('#option_id').val(),"_blank");
    }
</script>
