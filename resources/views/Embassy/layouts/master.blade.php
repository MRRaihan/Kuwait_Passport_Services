...
<head>
    @include('Embassy.layouts.includes.head')
</head>
...
<body class="fixed-left">
    ...
    <div id="wrapper">
        ...
        <!-- Top Bar Start -->
        @include('Embassy.layouts.includes.topbar')
        <!-- Top Bar End -->
        <!-- ========== Left Sidebar Start ========== -->

        @include('Embassy.layouts.includes.navbar')
        <!-- Left Sidebar End -->
        ...
        <div class="content-page">
            ...
            @include('Embassy.layouts.includes.footer')
        </div>
    ...
    @include('Embassy.layouts.includes.foot')
