<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="{{ route('embassy.dashboard') }}" style="margin-left: 15px;" class="logo"><img src="{{ asset('assets/embassy/images/embassy.png') }}" style="width: 100%; height: 100%;padding-left: 25px" height="28"></a>
            {{-- <a href="{{ route('embassy.dashboard') }}" class="logo"><img src="{{ asset('assets/embassy/images/admin-2.png') }}" style="width: 100%; height: 55px;" height="28"></a> --}}
            <a href="{{ route('embassy.dashboard') }}" class="logo-sm"><img src="{{ asset('assets/embassy/images/logo_sm.png') }}" height="36"></a>
        </div>
    </div>
