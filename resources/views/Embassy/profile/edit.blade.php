...
@push('title')
Edit Profile | Bangladesh Embassy
@endpush
...
<div class="content">
    <div class="container">
            ...
            <div class="col-sm-12">
                <div class="page-header-title">
                    ...
                    <ol class="breadcrumb pull-right">
                        <li><a href="{{ route('embassy.dashboard') }}">Bangladesh Embassy Panel</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <form action="{{ route('embassy.updateProfile') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @include('Others.message')
                    <div class="panel panel-primary">
                        <div class="panel-heading" style="background-color: #00674C !important;">
